...
93 89  89  01  #             ADDI    x19, x19, 24         # 152   # x19 = 172 = 0xAC (return address for JALR)             
6F 0A  00  02  #             JAL     x20, jal_target      # 156   # x20 = PC+4 = 160 = 0xA0(jump to target)               
...
13 0B  4B  01  #             ADDI    x22, x22, 20         # 180   # x22 = 172 + 20 = 192 = 0xC0
